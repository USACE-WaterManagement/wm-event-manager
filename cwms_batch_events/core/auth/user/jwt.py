...
PUBLIC_KEY = {
    ...
    "dev": "",
}


def get_public_pem():
    try:
        public_key = PUBLIC_KEY[settings.app_env]
    except KeyError as e:
        print(f"Cannot find PUBLIC_KEY for APP_ENV setting of '{settings.app_env}'")
        raise e

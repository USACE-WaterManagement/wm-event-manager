...
def make_job_record(**overrides) -> JobRecord:
    return JobRecord(
        ...
        execution_type=overrides.pop("execution_type", "github_file"),
...
def make_script_payload(**overrides) -> dict:
    return {
        ...
        "executionType": overrides.pop("executionType", "github_file"),
        "runtime": overrides.pop("runtime", "python"),
        ...
        "scheduleTimezone": overrides.pop("scheduleTimezone", "UTC"),
